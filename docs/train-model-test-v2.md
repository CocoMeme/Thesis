...
# Verify we're using TensorFlow 2.15.x (last version with Keras 2.x)
...
elif tf_version.startswith('2.') and int(tf_version.split('.')[1]) < 16:
    print(f"\n✅ Acceptable TensorFlow version: {tf_version}")
    print(f"✅ Keras version: {keras_version}")
    print("✅ Should be compatible with TensorFlow.js")
else:
    print(f"\n⚠️  WARNING: TensorFlow version is {tf_version}")
    print(f"⚠️  Keras version is {keras_version}")
    print("⚠️  Expected 2.15.x or earlier for Keras 2.x compatibility")
